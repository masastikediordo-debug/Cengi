...
- `forestbrawl.db` - Persistent SQLite player data
...
- **Database**: SQLite database stored on the persistent disk
  - Consider a multi-instance database for 1000+ concurrent players
